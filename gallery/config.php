...
$templatefile 			= "jacekspawa"; //Template filename (must be placed in 'templates' folder)
...
//LANGUAGE STRINGS
$label_home 			= "Galeria"; //Name of home link in breadcrumb navigation
...
$label_loading 			= "Wczytuję..."; //Thumbnail loading text
